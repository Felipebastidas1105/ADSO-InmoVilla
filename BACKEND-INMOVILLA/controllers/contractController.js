...
const getAll = async (req, res) => {
  ...
  const create = async (req, res) =>  {
    const data = req.body;
    try {
      const newcontract = await contractService.create(data.Cedula, data.Nombre, data.Fecha_Nac,data.Telefono,data.Email,data.Fecha_Pago,data.Estado_Contrato,data.Servicios_Incluidos);
